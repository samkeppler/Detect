...
def run(subject, df_data, df_demog, regress, tracts, hemi, metric, model_type='AutoEncoder'):
    # Dynamically select and initialize the anomaly detection model
    if model_type == "AutoEncoder":
        from models.autoencoder import AutoEncoderModel as Model
        model = Model(X_train=None, X_test=None, model_name="Autoencoder")  # Replace None with real data later
